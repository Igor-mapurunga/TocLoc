...
public class Local {
    ...
    private String tipoEspaco; // Ex.: Quadra de Beach Tennis, Campo de Futebol Society
    ...
    private User proprietario; // Proprietário do local esportivo

    @ManyToOne
    @JoinColumn(name = "usuario_locador_id", nullable = true)
    private User usuarioLocador; // Usuário que está alugando o local
